...
// CODE HERE
function applyBlackButton (element) {
    element.classList.add('black-button')
}

sayHelloButton.addEventListener('mouseover', () => {applyBlackButton(event.target)})
...
// CODE HERE
function removeBlackButton (element) {
    element.classList.remove('black-button')
}

sayHelloButton.addEventListener('mouseout', () => {removeBlackButton(event.target)})
